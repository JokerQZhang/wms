...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.joker.wms.service.impl.PasswordTokenManager#generateRecoveryToken(com.joker.wms.model.User)
     */
    @Override
    ...
    /**
     * @see com.joker.wms.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.joker.wms.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.joker.wms.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
