...
<body<decorator:getProperty property="body.id" writeEntireProperty="true"/><decorator:getProperty property="body.class" writeEntireProperty="true"/> class="skin-blue layout-top-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<c:url value="/editProfile"/>" class="btn btn-default btn-flat">修改密码</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<c:url value="/logoutr"/>" class="btn btn-default btn-flat">退出</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="container" id="content">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"><decorator:title/></a></li>
    ...
    <footer class="main-footer">
        <div class="container">
            <div class="pull-right hidden-xs">
                <b><fmt:message key="webapp.version"/></b> 2.3.3
            </div>

            <strong>&copy; <fmt:message key="copyright.year"/> <a href="<fmt:message key="company.url"/>"><fmt:message key="company.name"/></a></strong> All rights
            reserved.<c:if test="${pageContext.request.remoteUser != null}">
