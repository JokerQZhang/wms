...
<head>
    ...
    <form method="post" action="${ctx}/wmsd/partyGroupsTree" id="partyGroupSearchForm" class="form-inline" onsubmit="return ajaxSubmitFormUpdateAreas(this,$('#partyGroupSearchFormDiv'));">
	    ...
	    <div id="search" class="text-right">
	        ...
	        <div id="actions" class="btn-group">
		        ...
		        <a class="btn btn-primary btn-sm" href="#" onclick="ajaxLoadDaialog({url:'<c:url value='/wmsd/editPartyGroupCun'/>',title:'<fmt:message key="partyGroupDetail.heading"/>',width:600,height:500,beforeDialogOpen:beforePartyGroupFormOpen,afterDialogOpen:afterPartyGroupFormOpen,data:{isNowXiang:isNowXiang,method:'Add',from:'list'}})" >
