...
.tree li.parent_li>span:hover, .tree li.parent_li>span:hover+ul li span {
	...
	<div class="col-sm-7">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    ...
		    <div id="dtlinfo">
		    	<jsp:include page="/WEB-INF/pages/wms/zhibudtl.jsp" flush="true"></jsp:include>
		    </div>
		  </div>
		</div>
	</div>
	...
	function zhibuTreeSelect(partyId, isDangWei){
		...
		$.ajax({
			url:"<c:url value='/wmsd/zhibuInfoDtl'/>"
			,type:"post"
	...
	function addPeople(){
		...
		ajaxLoadDaialog({url:'<c:url value='/wmsd/editDangPerson'/>',title:'党员信息',width:1100,height:500,beforeDialogOpen:undefined,afterDialogOpen:afterPartyGroupFormOpen,data:{belongGroupId:selectedGroupId,method:'Add',from:'list'}});
	}
	function addPositivePeople(){
		...
		ajaxLoadDaialog({url:'<c:url value='/wmsd/editPositivePerson'/>',title:'发展党员信息',width:1100,height:500,beforeDialogOpen:undefined,afterDialogOpen:afterPartyGroupFormOpen,data:{belongGroupId:selectedGroupId,method:'Add',from:'list'}});
	}
	</script>
