...
<div class="col-sm-12">
    <s:form id="alarmSetForm" action="saveAlarmSet" method="post" validate="false" cssClass="well" onsubmit="return ajaxSubmitFormUpdateAreas(this,undefined,afterSaveAlarmSet);">
        ...
        <div class="form-group col-sm-12">
				        	  <label><fmt:message key="alarmSet.kpiName"/><s:fielderror fieldName="alarmSet.kpiName"/></label>
        ...
        <div class="form-group col-sm-12">
				        	  <label><fmt:message key="alarmSet.maxValue"/><s:fielderror fieldName="alarmSet.maxValue" escape="false"/></label>
